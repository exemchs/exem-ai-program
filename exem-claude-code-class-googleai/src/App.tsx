          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
            {[
              ...
              },
              {
                ...
                linkText: os === 'mac' ? "git-scm.com에서 다운로드 (또는 brew install git)" : "git-scm.com에서 다운로드"
              },
              {
                step: "③",
                title: "Node.js",
      ...
      <section className="py-32 bg-zinc-900/30 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto grid sm:grid-cols-2 gap-4">
            {[
              { key: "Shift + Tab", desc: "명령어 자동 완성 및 추천" },
              { key: "/help", desc: "사용 가능한 명령어 및 도움말 보기" },
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 rounded-3xl bg-zinc-900 border border-white/5">
              ...
              <div className="p-4 rounded-xl bg-black border border-white/5 font-mono text-sm text-zinc-300">
                <span className="text-zinc-500"># 팁: 터미널 탭을 3개 열고 각각 다른 규칙 설정</span><br />
                CLAUDE.md
              </div>
            </div>
      ...
      <section className="py-32 bg-zinc-900/30 border-y border-white/5">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="mt-12 text-center">
            <a href="https://blog.huns.site" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-zinc-900 border border-white/10 text-zinc-300 hover:text-white hover:border-white/30 transition-all">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="mt-32 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-zinc-500">
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="https://blog.huns.site" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">추가 팁 → blog.huns.site</a>
            </div>
          </div>
        </div>
      </footer>
