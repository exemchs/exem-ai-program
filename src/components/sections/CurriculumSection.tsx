...
const days: {
  ...
  },
  {
    ...
    lines: [
      ...
      { type: "divider", text: "" },
      { type: "text", text: "" },
      { type: "dim", text: "\"ChatGPT 웹이나 Claude 웹도 잘 되는데, 왜 굳이 터미널에서?\"" },
      { type: "dim", text: "좋은 질문입니다. 직접 비교해보면 답이 나옵니다." },
      { type: "text", text: "" },
      { type: "table-header", text: "  🌐 웹 Chat                💻 Claude Code" },
      { type: "table-row", text: "  파일을 복붙               내 파일을 직접 읽고 수정" },
      { type: "table-row", text: "  AI가 알아서 기억           CLAUDE.md로 내가 관리 + 팀 공유" },
      { type: "table-row", text: "  매번 비슷한 요청 반복       /명령어(Skill)로 자동화" },
      { type: "table-row", text: "  내 프로젝트 맥락 모름       프로젝트 전체를 이해" },
      { type: "text", text: "" },
      { type: "dim", text: "📞 웹 Chat = 전화 상담 — 매번 상황을 설명해야 하고, 끊으면 잊어버림" },
      { type: "dim", text: "🏢 Claude Code = 같이 일하는 동료 — 내 파일을 보고, 규칙을 기억" },
      { type: "text", text: "" },
      { type: "highlight", text: "Claude Code는 더 똑똑한 AI가 아니라, 더 많은 맥락을 가진 AI입니다." },
  ...
  },
  {
    ...
    command: "/day3",
    lines: [
      { type: "banner", text: "D A Y  3 :  도 구  연 결 하 기  —  M C P" },
      { type: "text", text: "" },
      { type: "quote", text: "\"아무리 뛰어난 AI도 데이터에서 고립되면 무력합니다.\"" },
      { type: "author", text: "— Anthropic, MCP 발표문" },
      { type: "text", text: "" },
      { type: "section", text: "[1] MCP 개념" },
      { type: "divider", text: "" },
      { type: "text", text: "" },
      { type: "dim", text: "MCP = AI에게 눈과 손을 달아주는 것" },
      { type: "dim", text: "USB-C가 하나의 포트로 모든 기기를 연결하듯," },
      { type: "dim", text: "MCP가 하나의 규격으로 모든 도구를 AI에 연결합니다." },
      { type: "text", text: "" },
      { type: "table-header", text: "  ❌ MCP 없을 때              ✅ MCP 있을 때" },
      { type: "table-row", text: "  브라우저 탭 전환하며 작업     한 곳에서 모든 도구 접근" },
      { type: "table-row", text: "  데이터를 복붙               직접 데이터를 가져옴" },
      { type: "table-row", text: "  \"캘린더 내용 알려줘\" → 불가  \"내일 일정 정리해줘\" → 실행" },
      { type: "text", text: "" },
      { type: "highlight", text: "마법은 더 똑똑한 모델이 아니라, 올바른 맥락 제공에 있다." },
      { type: "progress", text: "███░░░░░░░ 33%" },
    ],
  },
  {
